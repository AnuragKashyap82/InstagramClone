...
import com.anurag.instagram.databinding.ActivityCreatePostBinding;
...
public class CreatePostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(ContextCompat.getColor(CreatePostActivity.this, R.color.white));
        }
        ...
        binding.postFeedBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(caption)) {
            Toast.makeText(CreatePostActivity.this, "Enter your caption....!!!!", Toast.LENGTH_SHORT).show();
        } else if (image_uri == null) {
            Toast.makeText(CreatePostActivity.this, "Select image to be post....!!!", Toast.LENGTH_SHORT).show();
        } else {
            postFeed(caption);
        }
    }

    private void postFeed(String caption) {
                            ...
                            ref.child("" + timestamp)
                                    ...
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void unused) {
                                            ...
                                            addToMyPost(caption, timestamp, downloadImageUri);
                                            clearText();
                                        }
                                    })
    ...
    private void addToMyPost(String caption, long timestamp, Uri downloadImageUri) {
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("caption", "" + caption);
        hashMap.put("uid", "" + firebaseAuth.getUid());
        hashMap.put("postId", "" + timestamp);
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Users");
        ref.child(firebaseAuth.getUid()).child("MyPost").child(String.valueOf(timestamp))
                .setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
