...
public class ModelMessenger {
    ...
    public ModelMessenger(String uid, String email, String username, String online, String timestamp, String profileImage, String name, String bio, String website) {
        this.uid = uid;
        this.email = email;
